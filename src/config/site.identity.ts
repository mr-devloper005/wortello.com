export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'wortello',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Wortello',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'wortello.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://wortello.com',
